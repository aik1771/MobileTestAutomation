...
public class AppiumWrapper {
    ...
    public static AppiumDriver buildAppiumDriver() {
        ...
        capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "AlbertPhone");
        capabilities.setCapability(MobileCapabilityType.NO_RESET, false);
        capabilities.setCapability(MobileCapabilityType.APP, "/Users/agolubev/Downloads/ionic-conference-emulator.apk");
        ...
        capabilities.setCapability("avd","AlbertPhone");
